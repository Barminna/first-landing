...
const tools = [
...

    {
        ...
        level: 'Продвинутый',
        description:
            'Инструмент для построения автоматизированных сценариев.'
    },
...
async function loadPosts() {
    ...
    try {
        ...
        //
        // fetch() сам по себе
        // не считает HTTP 404 или 500
        // исключением JavaScript.
        //
        // Поэтому проверяем response.ok.

        if (!response.ok) {

            // Создаём ошибку вручную.
            //
            // После throw выполнение
        ...
        //
        // response.json()
        // преобразует JSON-ответ
        // сервера в JavaScript-данные.
        ...
        // сколько карточек действительно
        // было получено и показано.
        apiStatus.textContent =
        ...
        //
        // Она нужна разработчику.
        console.error(error);


        // Пользователю показываем
        // простое понятное сообщение.
        apiStatus.textContent =
