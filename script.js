...
function applyPostFilters() {
    ...
    // =================================
    // СОРТИРОВКА ПО ИМЕНИ АВТОРА А–Я
    // =================================
    ...
    if (sortValue === 'author-asc') {
        ...
        result.sort(
            function (postA, postB) {
                ...
                // Если автор вдруг не найден,
                // используем пустую строку,
                ...
                //
                // Например:
                // "Anton".localeCompare("Boris")
                // даст отрицательное число,
                // поэтому Anton окажется раньше Boris.
    ...
    // =================================
    // СОРТИРОВКА ПО ИМЕНИ АВТОРА я–а
    // =================================
...
// =================================
// СООБЩЕНИЕ:
// СНЯТИЕ ОШИБКИ + СЧЁТЧИК СИМВОЛОВ
// =================================
...
userMessageInput.addEventListener(
    ...
    () => {
        ...
        // Пользователь начал исправлять
        // сообщение — снимаем красную рамку.
